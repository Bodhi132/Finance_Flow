    ...
    useEffect(() => {
        const fetchProductHuntData = async () => {
            ...
            `,
                ...
                console.log(data.data.posts.edges.length);
            ...
            <div>
                <div className=" 2xl:px-28 xl:px-24 lg:px-16 px-10 lg:mt-[3rem] space-y-[3rem] pb-5">
                    ...
                    <div className='w-full bg-[#010D50] md:h-[21rem] md:rounded-l-3xl rounded-3xl flex max-md:flex max-md:flex-col justify-between relative'>
                        ...
                        <div className='md:w-[50%] h-3/6 md:h-full py-[3rem] px-[2rem] md:px-[2rem] lg:px-[3rem]'>
                ...
                <div className=" 2xl:px-28 xl:px-24 lg:px-16 px-10 mt-[3rem] space-y-[3rem] pb-5">
                    <div className={` flex flex-col lg:flex-row md:justify-center lg:justify-between ${dm_Sans.className}`}>
                        ...
                        <div className=" text-white xl:text-sm lg:text-xs font-light md:text-center lg:text-left flex flex-col lg:flex-row max-md:space-y-[1rem] md:space-x-[1rem]">
                            {
                                topics.map((ele, index) => (
                                    <div key={index} className={`cursor-pointer ${ele === topic ? 'bg-[#0328EE]' : 'bg-[rgb(255,255,255,0.1)]'} px-[1rem] lg:px-[2rem] xl:px-[3rem] flex items-center rounded-full justify-center m-0`} onClick={() => setTopic(ele)}>{ele}</div>
                                ))
                            }
                        </div>
                    </div>
                    <div className='flex flex-wrap justify-between'>
                        {products.filter((ele,ind)=>{
                            ...
                            (
                            <div key={product.node.id} className={` lg:w-[23.9rem] rounded-3xl overflow-hidden flex flex-col bg-[#010D50] ${dm_Sans.className} mb-[2rem] pb-[1rem]`}>
